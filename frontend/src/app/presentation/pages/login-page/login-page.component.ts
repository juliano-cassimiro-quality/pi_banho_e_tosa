  ...
  template: `
    <section class="auth">
      <div class="card">
        ...
        <p class="subtitle">Gerencie agendamentos, pets e indicadores em um painel premium.</p>
        <form [formGroup]="form" (ngSubmit)="submit()" novalidate>
          <label>
            E-mail
            <input type="email" formControlName="email" placeholder="luma@banhoetosa.com" />
          </label>
          <label>
            Senha
